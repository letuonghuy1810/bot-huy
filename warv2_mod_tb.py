...
def thong_bao(message):
    ...
    # LẤY NỘI DUNG
    noi_dung = message.text.replace("/tb", "").strip()
    ...
    if message.reply_to_message:
        ...
        # VIDEO
            ...
            bot.reply_to(message, "⚠️ Reply vào ảnh/video để gửi media")
            return
    ...
    # =========================
        ...
        if not noi_dung:
            bot.reply_to(message, "⚠️ Nhập nội dung thông báo")
            return
